...
function Body() {
  return (
    <div className="rounded-3xl my-2 p-4" style={{ background: "#191724" }}>
      <div className="flex items-center  ">
        ...
        <div className="text-cente px-2 ">
          ...
          <p className="text-white my-2">
            ...
            develop many more varied things that come from my imagination. I am
            very passionate about programming and cybersecurity, I am fullstack
