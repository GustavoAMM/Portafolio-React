import { FcOpenedFolder, FcInvite, FcInfo, FcHome } from "react-icons/fc";
  ...
  return (
    ...
    <div className="xl:flex sm:grid grid xl:h-screen xl:w-full sm:h-full sm:w-full w-full h-full">
      ...
      <div className="xl:w-24 xl:h-full sm:w-full sm:h-20 w-full h-16 xl:grid sm:flex flex xl:justify-items-center xl:content-center">
        {/* Navbar */}
        <nav className="xl:rounded-3xl sm:rounded-b-3xl rounded-b-3xl xl:grid sm:flex flex xl:w-12 xl:h-72 sm:w-full sm:h-20 w-full h-20 xl:justify-items-center xl:content-around sm:justify-around sm:items-center justify-around items-center bg-[#191724]">
          <Link to="/">
      ...
      {/* Container renderizable de las páginas */}
