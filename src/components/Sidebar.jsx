...
function Sidebar() {
  return (
    <div className="xl:grid sm:flex flex xl:content-around sm:justify-around justify-around xl:h-full items-center">
      {/* About me */}
      ...
      {/* CV */}
      <div className="rounded-3xl xl:p-4 sm:py-6 p-4 xl:h-full sm:h-full h-full" style={{ background: "#191724" }}>
