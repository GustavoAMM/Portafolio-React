...
function Card({ info }) {
    //Sacar los tags de la data
    let tagles = info.tag;

    if (info) {
        //Devolver si hay data
        return (
            <a href={info.link} target="_blank">
                <div className="w-60 my-2 rounded-2xl bg-[#272436] h-[300px] hover:scale-105">
                    <Image
                        src={info.banner}
                        objectFit="cover"
                    ...
                    <div className="card-Body">
                        ...
                        <h1 className="card-title text-white font-bold">{info.title}</h1>
            ...
            <div className="w-60 justify-items-center my-2 rounded-2xl bg-[#272436] h-[300px]  hover:scale-105">
                ...
                <div className="card-Body">
                    ...
                    <div className="container-description text-center m-0 py-4 text-white">
                        <p>Incorrect or incomplete name</p>
                    </div>
                </div>
            </div>
        );
