...
function Text() {
  return (
    <div className="h-full xl:pt-0 sm:pt-0 pt-10 rounded-3xl xl:grid sm:flex" style={{ background: "#191724" }}>
      ...
      <p className="text-white text-justify px-8 texto-body xl:pt-2 sm:py-4 py-4 text-lg">
